...
const PerfilBibliotecarioPage = () => {
  ...
  const handleGuardar = async () => {
    ...
    if (!telefono.trim()) {
      setMensaje({
        tipo: 'error',
        texto: 'El teléfono no puede estar vacío'
      })
      return
    }
    ...
    try {
      ...
      setMensaje({
        tipo: 'error',
        texto: 'Error al guardar. Intentá de nuevo.'
      })
    ...
    <div className="perfil">
      ...
      <div className="perfil__card">
        ...
        {mensaje && (
          ...
          <p
            className={`perfil__mensaje perfil__mensaje--${mensaje.tipo}`}
          >
...
export default PerfilBibliotecarioPage